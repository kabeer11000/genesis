...
Protein Protein::fromPDB(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        if (line.substr(0, 4) == "ATOM" && line.substr(12, 4) == " CA ") {
            ...
            if (res_name == "ALA") aa_code = 'A';
            else if (res_name == "ARG") aa_code = 'R';
            else if (res_name == "ASN") aa_code = 'N';
            else if (res_name == "ASP") aa_code = 'D';
            else if (res_name == "CYS") aa_code = 'C';
            else if (res_name == "GLN") aa_code = 'Q';
            else if (res_name == "GLU") aa_code = 'E';
            else if (res_name == "GLY") aa_code = 'G';
            else if (res_name == "HIS") aa_code = 'H';
            else if (res_name == "ILE") aa_code = 'I';
            else if (res_name == "LEU") aa_code = 'L';
            else if (res_name == "LYS") aa_code = 'K';
            else if (res_name == "MET") aa_code = 'M';
            else if (res_name == "PHE") aa_code = 'F';
            else if (res_name == "PRO") aa_code = 'P';
            else if (res_name == "SER") aa_code = 'S';
            else if (res_name == "THR") aa_code = 'T';
            else if (res_name == "TRP") aa_code = 'W';
            else if (res_name == "TYR") aa_code = 'Y';
            else if (res_name == "VAL") aa_code = 'V';
...
void BatchExperimentRunner::runMutationRateSweep() {
    ...
    for (double rate : mutation_rates) {
        ...
        for (double f : fitness) avg_fitness += f;
